...
contract Frameme is ERC721, Ownable {
    ...
    modifier onlyAuthorizedMinter() {
        require(authorizedMinters[msg.sender], "Frameme: Mint must be triggered by API");
        _;
    }

    modifier onlyBelowMaxMint(address to) {
        require(mintCount[to] < maxMintPerAddress, "Frameme: Max mint reached");
        _;
    }
    ...
    constructor() ERC721("Frameme", "MEME") Ownable(msg.sender) {
        // Update this with your own NFT collection's metadata
        defaultURI = "arweave.net/D9Odbo39RNxBTze_sFAgPaEJkS8RDMX0zGwOObd2j-c";
    ...
    function authorizeBaseMainnetSyndicateAPI() internal {
        ...
        authorizedMinters[0xCeb39c8006BcEB8beFC495a15C1160B23ACdad21] = true;
        ...
        emit AuthorizedMinterSet(0xCeb39c8006BcEB8beFC495a15C1160B23ACdad21, true);
    }

    fallback() external payable {
        revert("Frameme: Does not accept ETH");
    }
}